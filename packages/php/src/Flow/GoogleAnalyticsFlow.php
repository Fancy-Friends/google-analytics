 ...
 */
/**
 * Every Google Analytics node executor — the PHP twin of
 * `GOOGLE_ANALYTICS_RUNNABLE_KINDS` in @particle-academy/google-analytics-js.
 *
 * Each class declares its kind in a `#[FlowNode]` attribute. Two ways onto a
 * host:
 *
 * - `GoogleAnalyticsFlow::register($kinds, $executors)` — one call, no
 * directory scan.
 ...
 */
final class GoogleAnalyticsFlow
{
