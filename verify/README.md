...
| Registry | Package |
|---|---|
| npm | `@particle-academy/google-analytics-js` (+ `@particle-academy/google-analytics-ui`, resolved transitively) |
...
npm install @particle-academy/google-analytics-js @particle-academy/fancy-flow
